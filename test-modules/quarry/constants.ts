...
import QuarryMineJSON from "./idls/quarry_mine.json";
import QuarryMintWrapperJSON from "./idls/quarry_mint_wrapper.json";
import QuarryRedeemerJSON from "./idls/quarry_redeemer.json";
import QuarryMergeMineJSON from "./idls/quarry_merge_mine.json";
import QuarryOperatorJSON from "./idls/quarry_operator.json";
import QuarryRegistryJSON from "./idls/quarry_registry.json";
import type {
  MineProgram,
  MineTypes,
  MintWrapperProgram,
