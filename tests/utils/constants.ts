...
// seeds
export const USD_TOKEN_SEED = "USD_TOKEN_SEED"; // prev: USD_TOKEN_TAG & usd-token
...
export const MINT_USD_SEED = "MINT_USD_SEED"; // prev: USD_MINT_TAG & usd-mint
export const USD_MINT = "USD_MINT";
export const USD_TOKEN = "USD_TOKEN";
